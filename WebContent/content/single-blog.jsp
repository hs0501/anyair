            ...
            <div class="row justify-content-center">
                <div class="col-12 col-lg-8">
                    ...
                    <div class="post-thumbnail mb-50">
                        <img src="<%=request.getContextPath()%>/img/bg-img/39.jpg" alt="">
                    </div>
                    <!-- Blog Details Text -->
                    <div class="blog-details-text">
                        ...
                        <blockquote class="roberto-blockquote d-flex">
                            <div class="icon">
                                <img src="<%=request.getContextPath()%>/img/core-img/quote.png" alt="">
                            </div>
                            <div class="text">
                        ...
                        <ol>
                            ...
                            <li class="single_comment_area">
                                ...
                                <div class="comment-content d-flex">
                                    ...
                                    <div class="comment-author">
                                        <img src="<%=request.getContextPath()%>/img/bg-img/40.jpg" alt="author">
                                    </div>
                                    <!-- Comment Meta -->
                                ...
                                <ol class="children">
                                    <li class="single_comment_area">
                                        ...
                                        <div class="comment-content d-flex">
                                            <!-- Comment Author -->
                                            <div class="comment-author">
                                                <img src="<%=request.getContextPath()%>/img/bg-img/41.jpg" alt="author">
                                            </div>
                                            <!-- Comment Meta -->
                                            <div class="comment-meta">
                            ...
                            <li class="single_comment_area">
                                ...
                                <div class="comment-content d-flex">
                                    <!-- Comment Author -->
                                    <div class="comment-author">
                                        <img src="<%=request.getContextPath()%>/img/bg-img/42.jpg" alt="author">
                                    </div>
                                    <!-- Comment Meta -->
                                    <div class="comment-meta">
                                        <a href="#" class="post-date">27 Aug 2018</a>
